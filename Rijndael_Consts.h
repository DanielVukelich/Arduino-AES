#ifndef RIJNDAEL_CONST_H
#define RIJndAEL_CONST_H

const unsigned char GF_POLYNOMIAL = 0x1b;
...
const unsigned char SBOX_INVERSE[256] = {
...
const unsigned char MIX_COL[16] = {
  0x02, 0x03, 0x01, 0x01,
  0x01, 0x02, 0x03, 0x01,
  0x01, 0x01, 0x02, 0x03,
  0x03, 0x01, 0x01, 0x02,
...
const unsigned char MIX_COL_INV[16] = {
  0x0e, 0x0b, 0x0d, 0x09,
  0x09, 0x0e ,0x0b, 0x0d,
  0x0d, 0x09, 0x0e, 0x0b,
  0x0b, 0x0d, 0x09, 0x0e
...
const unsigned char GF_MUL_2[256] = {
...
const unsigned char GF_MUL_3[256] = {
...
const unsigned char GF_MUL_9[256] = {
...
const unsigned char GF_MUL_11[256] = {
...
const unsigned char GF_MUL_13[256] = {
...
const unsigned char GF_MUL_14[256] = {
